...
setup(
    ...
    url="https://github.com/starofrainnight/freeplane-helper",
    packages=find_packages(),
    entry_points={
        "console_scripts": ["freeplane-helper=freeplanehelper.__main__:main"]
    },
    include_package_data=True,
    install_requires=install_requires,
    license="Apache Software License",
    zip_safe=False,
    keywords="freeplanehelper,freeplane-helper",
    classifiers=[
